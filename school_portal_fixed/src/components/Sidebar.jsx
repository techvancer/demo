...
import {
    LayoutDashboard, UserCog, Users, BookOpen, FileEdit,
    ClipboardList, CalendarCheck, CalendarDays, LogOut,
    PlayCircle, Shield, Layers, BarChart, GraduationCap, Link, X, Presentation
} from 'lucide-react';
...
const getNavItems = (role, lang) => {
    ...
    if (role === 'Admin') {
        return [
            ...base,
            { icon: UserCog,       label: t('employees', lang),   path: '/admin/employees' },
            { icon: Users,         label: t('teachers', lang),    path: '/admin/teachers' },
            { icon: Shield,        label: t('supervisors', lang), path: '/admin/supervisors' },
    ...
    return [
        ...base,
        { icon: Presentation,  label: t('myClasses', lang), path: '/classes' },
