...
export default function SupervisorDashboard() {
    ...
    const handleReset = () => { setApplied({ ...EMPTY_FILTER }); setHasApplied(false); setStats({ teachers:0,students:0,exams:0,sections:0,classes:0,subjects:0 }); setClassPerfData([]); setGradeData([]); };
    ...
    return (
        <div className="space-y-6 animate-fade-in pb-12">
            <div>
                ...
                <p className="text-[#64748b] text-sm">{t('welcomeBack', lang)}, {user?.name}. {t('dashboardOverview', lang)}</p>
            </div>
