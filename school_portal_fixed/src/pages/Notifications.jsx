    ...
    return (
        <div className="space-y-6 animate-fade-in pb-12">
            <div>
                ...
                <p className="text-[#64748b] text-sm">Stay updated with school activities and alerts</p>
            </div>
            ...
            <div className="card p-24 bg-white rounded-2xl shadow-sm border-[#e2e8f0] flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-xl font-bold text-[#0f172a] mb-2">No notifications yet</h2>
