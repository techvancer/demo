    ...
    return (
        <div className={`space-y-6 pb-12 ${shake ? 'animate-shake' : ''}`}>
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-[#0f172a]">Edit Exam</h1>
                    <p className="text-[#64748b] text-sm font-medium">Modify exam details and questions with video solutions</p>
                </div>
            </div>

            {/* Section 1: Exam Details */}
            <div className="card p-6 bg-white space-y-6">
                <h2 className="text-lg font-bold text-[#0f172a] border-b border-[#e2e8f0] pb-4">Exam Details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-[#334155]">Total Questions</label>
                        <input
                            type="number"
                            readOnly
