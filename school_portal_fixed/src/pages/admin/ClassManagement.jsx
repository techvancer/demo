                                    ...
                                    <tbody className="divide-y divide-[#e2e8f0]">
                                        {classData.students.map((s, i) => (
                                            <tr key={i} className="hover:bg-[#eff6ff] transition-colors group">
                                                <td className="px-6 py-4 text-sm font-bold text-[#0f172a]">{s.name}</td>
                                                <td className="px-6 py-4 text-sm text-[#475569] font-mono">{s.id}</td>
                                                <td className="px-6 py-4 text-sm text-[#475569]">{s.section}</td>
                                                <td className="px-6 py-4">
                                                    <span className={`text-sm font-bold ${s.avg >= 85 ? 'text-green-600' : 'text-orange-600'}`}>{s.avg}%</span>
                                                </td>
                                                <td className="px-6 py-4 text-sm text-[#475569] font-medium">{s.attendance}%</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                                    ...
                                    <tbody className="divide-y divide-[#e2e8f0]">
                                        {classData.teachers.map((t, i) => (
                                            <tr key={i} className="hover:bg-[#eff6ff] transition-colors cursor-pointer group">
                                                ...
                                                <td className="px-6 py-4 text-sm text-[#475569] font-medium">{t.subject}</td>
                                                <td className="px-6 py-4 text-sm text-[#475569]">{t.sections}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
