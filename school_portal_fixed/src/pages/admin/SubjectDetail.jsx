                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                            <tr>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('name', lang)}</th>
            ...
            <div className="card bg-white rounded-xl overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                            <tr>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('class', lang)}</th>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('section', lang)}</th>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('stage', lang)}</th>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('students', lang)}</th>
                                <th className="px-6 py-3 text-xs font-bold text-[#64748b] uppercase tracking-wider">{t('teacher', lang)}</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-[#f1f5f9]">
                            {classes.length === 0 ? (
                                ...
                                <tr key={i} className="hover:bg-[#f8fafc] transition-colors">
                                    <td className="px-6 py-4 text-sm font-bold text-[#0f172a]">{t('class', lang)} {c.classname}</td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4 text-sm font-bold text-[#0f172a]">{c.studentCount}</td>
                                    <td className="px-6 py-4">
