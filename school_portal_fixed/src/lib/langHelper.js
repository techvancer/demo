...
export const UI_LABELS = {
    ...
    markDistribution: { en: 'Mark Distribution', ar: 'توزيع الدرجات' },
    ...
    markDistributionDetail: { en: 'Mark Distribution', ar: 'توزيع الدرجات' },
    ...
    manageVideosDesc: { en: 'Manage YouTube videos attached to exam questions.', ar: 'إدارة فيديوهات اليوتيوب المرفقة لأسئلة الامتحان.' },
