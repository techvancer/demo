...
export async function loadGrades() {
    ...
    try {
        const SUPABASE_URL = 'https://odrrbazlehamooggsouv.supabase.co';
        const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9kcnJiYXpsZWhhbW9vZ2dzb3V2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI0OTE3ODEsImV4cCI6MjA4ODA2Nzc4MX0.o2hqPzmPDZvPAKyC2bCzVfBKI21cP1ZB78OIWRociow';
        const res = await fetch(`${SUPABASE_URL}/rest/v1/Grades_tbl?select=gradeid,gradename,frommark,tomark&order=tomark.desc`, {
