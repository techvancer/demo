          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select className={sel} value={form.divisionid} onChange={e => set('divisionid', e.target.value)}>
                ...
                {divisions.map((d, i) => <option key={`${d.divisionid}-${i}`} value={d.divisionid}>{getField(d, 'divisionname', 'divisionname_en', lang) || d.divisionname}</option>)}
              </select>
            </div>
            <div>
              ...
              <select className={sel} value={form.curriculumid} onChange={e => set('curriculumid', e.target.value)}>
                <option value="">{t('default', lang)}</option>
                {curriculums.map((c, i) => <option key={`${c.curriculumid}-${i}`} value={c.curriculumid}>{getField(c, 'curriculumname', 'curriculumname_en', lang) || c.curriculumname}</option>)}
              </select>
            </div>
          </div>
        </div>
