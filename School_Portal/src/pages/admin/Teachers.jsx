                            ...
                            {!hasApplied ? (
                                ...
                                selectedTeacher?.employeeid === teacher.employeeid && isEditModalOpen ? (
                                    <tr key={teacher.employeeid} className="bg-amber-50/50">
                                        ...
                                        <td className="px-4 py-3 text-center"><input className="input-field h-9 w-full" placeholder={t('arabicName', lang)} value={formData.employeename} onChange={e => setFormData(f => ({ ...f, employeename: e.target.value }))} /></td>
                                        <td className="px-4 py-3 text-center"><input className="input-field h-9 w-full" placeholder={t('englishName', lang)} value={getField(formData, 'employeename', 'employeename_en', lang)} onChange={e => setFormData(f => ({ ...f, employeename_en: e.target.value }))} /></td>
                            ...
                            <form onSubmit={handleCreate}>
                                ...
                                <div className="p-8 space-y-5">
                                    <div className="space-y-2">
                                        ...
                                        <input required type="text" className="input-field h-11" placeholder={isAr ? "مثال: أحمد محمود" : "e.g. أحمد محمود"} value={formData.employeename} onChange={e => setFormData(f => ({ ...f, employeename: e.target.value }))} />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold text-[#0f172a]">{t('englishNameLabel', lang)}</label>
                                        <input required type="text" className="input-field h-11" placeholder={isAr ? "مثال: Ahmed Mahmoud" : "e.g. Ahmed Mahmoud"} value={getField(formData, 'employeename', 'employeename_en', lang)} onChange={e => setFormData(f => ({ ...f, employeename_en: e.target.value }))} />
                                    </div>
                                    <div className="space-y-2">
