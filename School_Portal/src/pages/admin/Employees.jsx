                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex flex-col gap-2">
                      <div>
                        ...
                        <input required className="input-field h-9" placeholder={t('arabicName', lang)} value={formData.employeename} onChange={(e) => setFormData((p) => ({ ...p, employeename: e.target.value }))} />
                      </div>
                      <div>
                        <label className="text-[11px] font-bold text-[#64748b] mb-1 block">{t('englishName', lang)} <span className="text-red-500">*</span></label>
                        <input required className="input-field h-9" placeholder={t('englishName', lang)} value={formData.employeename_en || ''} onChange={(e) => setFormData((p) => ({ ...p, employeename_en: e.target.value }))} />
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-center">
                  ...
                  <tr key={employee.employeeid} className="bg-amber-50/50 align-top">
                    ...
                    <td className="px-4 py-3 text-center">
                      <div className="space-y-2 min-w-[280px]">
                        <div><label className="text-[11px] font-bold text-[#64748b] mb-1 block">{t('arabicName', lang)} <span className="text-red-500">*</span></label><input className="input-field h-9" value={editData.employeename} onChange={(e) => setEditData((p) => ({ ...p, employeename: e.target.value }))} /></div>
                        <div><label className="text-[11px] font-bold text-[#64748b] mb-1 block">{t('englishName', lang)} <span className="text-red-500">*</span></label><input className="input-field h-9" value={editData.employeename_en || ''} onChange={(e) => setEditData((p) => ({ ...p, employeename_en: e.target.value }))} /></div>
