                        ...
                        <tbody className="divide-y divide-[#e2e8f0]">
                            {showAddRow && (
                                <tr className="bg-blue-50/40">
                                    ...
                                    <td className="px-4 py-3 text-center"><div className="flex flex-col gap-1"><input className="input-field h-9" placeholder={t('arabicName', lang)} value={formData.employeename} onChange={e => setFormData(p => ({ ...p, employeename: e.target.value }))} /><input className="input-field h-9" placeholder={t('englishName', lang)} value={getField(formData, 'employeename', 'employeename_en', lang)} onChange={e => setFormData(p => ({ ...p, employeename_en: e.target.value }))} /></div></td>
                            ...
                            {!hasApplied ? (
                                ...
                                selectedSup?.employeeid === s.employeeid && isEditOpen ? (
                                    <tr key={s.employeeid} className="bg-amber-50/50">
                                        ...
                                        <td className="px-4 py-3 text-center"><input className="input-field h-9 w-full" placeholder={t('englishName', lang)} value={getField(editData, 'employeename', 'employeename_en', lang)} onChange={e => setEditData(p => ({ ...p, employeename_en: e.target.value }))} /></td>
